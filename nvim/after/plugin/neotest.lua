...
vim.keymap.set("n", "<space>to", function() neotest.output.show() end, { desc = "[test] show output" })
vim.keymap.set("n", "<space>ts", function() neotest.summary.show() end, { desc = "[test] show summary" })
